(() => {
  ...
  const pages = {
    ...
    map: { type: 'map', eyebrow: 'Find your way', title: 'The whole wonder, at your fingertips.', intro: 'Zoom and pan across Wall Drug, then see exactly where to find us in Wall, South Dakota.', heroImage: `${A}wall-drug-storefront.jpg`, image: `${A}map/walldrug-map.jpg` },
